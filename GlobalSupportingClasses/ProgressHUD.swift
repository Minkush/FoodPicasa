...
public class ProgressHUD: UIView {
    ...
    class var sharedInstance: ProgressHUD {
        struct Singleton {
            static let instance = ProgressHUD(frame: CGRectMake(0,0,Config().size,Config().size))
        }
    ...
    public class func setconfig() {
        var config : ProgressHUD.Config = Config()
        config.size = 120
    ...
    public class func show(title: String?, animated: Bool, topMargin: Int) {
        ...
        let loader = ProgressHUD.sharedInstance
